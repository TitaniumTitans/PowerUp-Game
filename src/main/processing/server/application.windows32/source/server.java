...
public boolean removeRobot (int ID, String IP) { // returns false if this is NOT your robot, or the specified robot couldn't be found
  for (int i = 0; i < robots.length; i++) {
...
class DropCenterRobot extends Robot {
  ...
  public void settings() {  size(800, 500);  noSmooth(); }
