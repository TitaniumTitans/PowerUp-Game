...
public class StructureBuilder extends PApplet {
...
public void fileSelected(File selection) {        // Called when the loadImage method finishes.
...
public void keyReleased(){loop();}

public void mousePressed(){}
public void mouseReleased(){loop();}
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "StructureBuilder" };
    if (passedArgs != null) {
